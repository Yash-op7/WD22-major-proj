...
<head>
    ...
    <meta name="author" content="Yash MSC"/>
...
<body>
    <div class="header">
        ...
        <div class="heading">
            ...
            <!-- <p style="border:none;padding:0px;position:relative;bottom:40px;right:12px;">A movie streaming website</p> -->
        </div>
    ...
    <div class="main">
        <center>
            <!-- <h2><i>Welcome</i></h2> -->
            <h3><i>RECENTLY ADDED</i></h3>
        </center>
        <div class="wrapper">

        <?php
            $sql_query="select * from movies_list";
        ...
        ?>
            ...
            <div class="movie-card">
                ...
                <div class="descriptions" style="font-family:'Finlandica';font-weight:bold">
